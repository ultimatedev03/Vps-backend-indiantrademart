...
export const isVisibleCatalogPlan = (plan = null) => {
  ...
  if (!name || name === 'trial' || name.includes('trial')) return false;
...
export const VENDOR_PLAN_CATALOG = [
  {
    ...
    description: 'Self-serve entry plan for basic listing visibility and starter lead access.',
    price: 4999,
    daily_limit: 2,
    weekly_limit: 10,
    yearly_limit: 300,
    ...
    features: baseFeatures({
      badge: { label: 'Starter', variant: 'starter' },
      listing: { highlight: true },
      leads: { rfq_access: true },
      support: { level: 'standard' },
      analytics: { enabled: false },
      coverage: { states_limit: 1, cities_limit: 5 },
  ...
  {
    name: 'Growth Leads',
    description: 'Self-serve plan for vendors who want more lead capacity and stronger listing placement.',
    price: 14999,
    daily_limit: 8,
    weekly_limit: 45,
    yearly_limit: 1500,
    ...
    is_active: true,
    features: baseFeatures({
      badge: { label: 'Growth', variant: 'growth' },
      listing: { highlight: true, featured: true, home_category_boost: true },
      leads: { priority_leads: true, rfq_access: true, direct_call_whatsapp: true },
      support: { level: 'priority', response_sla_hours: 24 },
      analytics: { enabled: true },
      coverage: { states_limit: 3, cities_limit: 25 },
      portfolio: { enabled: true, template: 'STANDARD' },
      certificate: { enabled: false },
  ...
  {
    name: 'Pro Visibility',
    description: 'Self-serve plan with verified profile signals, analytics, and better category visibility.',
    price: 29999,
    daily_limit: 20,
    weekly_limit: 120,
    yearly_limit: 4000,
    ...
    features: baseFeatures({
      ...
      coverage: { states_limit: 6, cities_limit: 60 },
  ...
  {
    name: 'Silver Verified Portfolio',
    description: 'Sales-assisted premium plan with certified vendor badge, portfolio page, and SEO-ready profile structure.',
    price: 75000,
    daily_limit: 40,
    weekly_limit: 250,
    yearly_limit: 9000,
    ...
    features: baseFeatures({
      ...
      coverage: { states_limit: 10, cities_limit: 100 },
      portfolio: {
        enabled: true,
        template: 'PREMIUM',
        customizable: true,
  ...
  {
    name: 'Gold SEO Portfolio',
    description: 'Sales-assisted premium SEO plan with custom profile content, certificate, and extended sitemap reach.',
    price: 150000,
    daily_limit: 80,
    weekly_limit: 600,
    yearly_limit: 22000,
    ...
    features: baseFeatures({
      ...
      coverage: { states_limit: 18, cities_limit: 250 },
      portfolio: {
        enabled: true,
        template: 'PREMIUM',
        customizable: true,
  ...
  {
    name: 'Diamond Showcase Portfolio',
    description: 'Sales-assisted flagship plan for a custom showcase portfolio, diamond certificate, managed SEO, and maximum sitemap expansion.',
    price: 300000,
    daily_limit: 150,
    weekly_limit: 1200,
    yearly_limit: 50000,
    ...
    features: baseFeatures({
      ...
      analytics: { enabled: true, export_csv: true, campaign_insights: true, competitor_insights: true },
      coverage: { states_limit: 36, cities_limit: 500 },
      portfolio: {
        enabled: true,
        template: 'PREMIUM',
        customizable: true,
